package org.example.msvcchat.client;
...
public class GroqClient {
    ...
    public GroqClient(
        ...
        this.rest.setErrorHandler(new DefaultResponseErrorHandler() {
            ...
            @Override
            public void handleError(java.net.URI url, HttpMethod method, ClientHttpResponse response) throws IOException {
                // Delegar a la versión de un argumento para evitar duplicación
